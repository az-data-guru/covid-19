...
for county in counties:
    filein=f"F:/OneDrive\OneDrive - The E.W. Scripps Company/R Projects\Hospital-Referral-Region-graphic/covid/Data/2020-09-16/countyCases{yesterday.isoformat()}-{county}.csv"
...
fileout=f"AllCases{today.isoformat()}.csv"
